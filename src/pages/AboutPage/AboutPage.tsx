...
export const AboutPage = () => {
  return (
    <section>
      ...
      <h1>About us</h1>
      <p>
        This project was implemented by a team of students from rsschool 2023Q1 Three React Ninjas. The team
        communicated via discord. The project was maintained in github projects.
      </p>
